...
To start listening, use the script in .../Mailpile/scripts/mp_ssh_server_start.sh .

To stop listening and terminate connections, use the script in .../Mailpile/scripts/mp_ssh_server_stop.sh .
...
To terminate a connection, use the script /system/bin/stopnnnnn.
